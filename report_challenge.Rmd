...
metadata <- read_csv("G:/My Drive/Thesis PhD Boris Polanco/asia_challenge/ASIA_CHALLENGE_SCI/ASIAChallenge_ShareFile/metadata.csv",col_names = TRUE)
...
train_features <- read_csv("G:/My Drive/Thesis PhD Boris Polanco/asia_challenge/ASIA_CHALLENGE_SCI/ASIAChallenge_ShareFile/train_features.csv",col_names = TRUE)
...
```{r , echo=FALSE,message=FALSE}
train_outcomes_MS <- read_csv("G:/My Drive/Thesis PhD Boris Polanco/asia_challenge/ASIA_CHALLENGE_SCI/ASIAChallenge_ShareFile/train_outcomes_MS.csv",col_names = TRUE)
...
```{r , echo=FALSE,message=FALSE}
train_outcomes_MS <- read_csv("G:/My Drive/Thesis PhD Boris Polanco/asia_challenge/ASIA_CHALLENGE_SCI/ASIAChallenge_ShareFile/test_features.csv",col_names = TRUE)
...
```{r , echo=FALSE,message=FALSE}
test_outcomes_MS <- read_csv("G:/My Drive/Thesis PhD Boris Polanco/asia_challenge/ASIA_CHALLENGE_SCI/ASIAChallenge_ShareFile/test_outcomes_MS_template.csv",col_names = TRUE)
